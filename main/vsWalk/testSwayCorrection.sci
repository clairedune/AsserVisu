...
function testSway(OPT_CORR,OPT_L_COURANT)

 
maxiter        = 200;               //
// -- Pose init and final of the robot in the world frame
posecMoInit    = [ 0.0 0 1 0  20*%pi/180 0]; // Object position in the init camera frame
posecMoDes     = [ 0.1 0 0.5 0 0 0 ]; // Object position in the init camera frame
