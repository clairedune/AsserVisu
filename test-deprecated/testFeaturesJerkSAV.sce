...
jerk_m      = 0.1*[ones(Np_m,1)];
for i=1:ndof_m-1
    jerk_m  = [jerk_m; zeros(Np_m,1)];
end   
[rMc,rVc,wMcom,wVcom]   = loadHRP2camComAll();
...
[sm_out, Z_out ]= predHorGlobalMireJerk(s,Z,stateCoM,rMc,jerk_m,Sp_m,Up_m,Sv_m,Uv_m,Sa_m,Ua_m,Te_m,Np_m,ndof_m);


global computeL_global ;
computeL_global= matIntMireC;
L_out = predInMatGlobalJerk(computeL_global,sm_out,Z_out,Np_m,Nbpts_m)
