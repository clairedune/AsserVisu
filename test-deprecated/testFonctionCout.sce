...
// -------- Sampling time
Te_m        = 0.08;   // to be consistant with the image frame rate
Te_simu     = Te_m;
...
Z_m,Nc_m,Np_m,Nbpts_m,Te_m,sDes_m,ZDes_m,Q_m,e0_m,xl_m,xu_m,bl_m,bu_m,Lfunction,OPT_INEQ);
...
while(err > thres_m & iter_m < 1000 )
  ...
  //--------------------------------------------------------//
   ...
   disp('Asservissement visuel classique')
    ...
    cost2      = cld_costSQPMire(1,v_m)
    cost3      = ga_costSQPMire(1,v_m)
  end
